export const listingPillBaseClass =
  "inline-flex items-center justify-center min-h-[1.625rem] rounded-full border border-neutral-200 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.16em] leading-none";
