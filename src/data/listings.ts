...
Contact FarmCash for full details.`,
   ...
   */
  {
    ...
    gallery: [
      { src: "/images/FC-2019-HORSCH-MAESTRO-1275-002/hero.png", alt: "Horsch Maestro 12.75 SW image 1 (hero)." },
      { src: "/images/FC-2019-HORSCH-MAESTRO-1275-002/1.png", alt: "Horsch Maestro 12.75 SW image 2." },
    ],
    description:
      "2019 Horsch Maestro 12.75 SW 12 row maize drill with approximately 5,500 hectares completed. Machine 14687 is available at £62,500 + VAT; some wear parts may be needed, and this can be reviewed once the buyer confirms suitability.",
    features: [
      "12 row maize drill",
      "Approx. 5,500 hectares",
      "Machine number 14687",
      "£62,500 + VAT",
    ],
    specs: [
      { label: "Brand", value: "Horsch" },
      { label: "Model", value: "Maestro 12.75 SW" },
      { label: "Category", value: "Maize drill" },
      { label: "Year", value: "2019" },
      { label: "Machine number", value: "14687" },
      { label: "Coverage", value: "5,500 hectares" },
      { label: "Price", value: "£62,500 + VAT" },
      { label: "Condition note", value: "Some wear parts may be required" },
      { label: "Location", value: "UK" },
    ],
    ctas: {
      whatsappUrl: WHATSAPP_URL,
